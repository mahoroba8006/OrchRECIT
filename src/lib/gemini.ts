...
- **AIコメント（reason）は最大200文字程度**とする。判断理由、判断が難しい場合はその理由、注意点、ためになる情報などについて要点のみを絞って短く簡潔に記述すること。
`;
        ...
        config: {
            ...
            responseSchema: {
                ...
                properties: {
                    ...
                    reason: { type: Type.STRING, description: "AIコメント（判断理由、判断が難しい場合はその理由、注意点、ためになる知識など。最大200文字程度で簡潔に）" }
                },
