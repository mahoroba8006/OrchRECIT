...
- **AIコメント（reason）は最大200文字程度**とし、「判断理由」「判断が難しい場合はその理由」「注意点」「ためになる情報や知識」「農業用と判断できない場合、農業経費とすることができる具体的な条件」などに要点を絞り、ダラダラ書かず短く簡潔に記述すること。
`;
        ...
        config: {
            ...
            responseSchema: {
                ...
                properties: {
                    ...
                    reason: { type: Type.STRING, description: "AIコメント（判断理由、判断が難しい理由、注意点、役立つ知識、農業用と判断できない場合の経費算入の具体的な条件など。最大200文字程度で簡潔に）" }
                },
