...
- 勘定科目 (購入内容や支払先から、農業青色申告決算書の経費科目を推測する。以下の定義に基づいて、必ず指定された選択肢のいずれか1つを厳密に抽出すること：
  - 「種苗費」：種、苗、球根など
  - 「肥料費」：肥料、堆肥、液肥、化成肥料、石灰など
  - 「農薬衛生費」：殺虫剤、殺菌剤、除草剤、展着剤など
  - 「諸材料費」：マルチ、支柱、防虫ネット、ビニール、段ボール等の梱包資材以外の農業用資材全般
  - 「農具費」：クワ、カマ、ハサミ、草刈り機の刃、その他10万円未満の農機具や道具
  - 「荷造運賃手数料」：段ボール等の出荷用梱包資材、送料
  - 「修繕費」：農機具や施設の修理部品、オイル等のメンテナンス用品
  - 「動力光熱費」：ハウスの暖房用燃料、電気代など
  - 「接待交際費」：贈答品、お茶菓子、飲食代など
  - 「租税公課」：収入印紙、組合費など
  - 「雑費」：上記に該当しない少額の経費
  - 「消耗品費」：文房具、事務用品、洗剤など。※重要：軍手やハサミ等の農業現場で使う道具や資材は安易に「消耗品費」とせず、極力「諸材料費」や「農具費」を選択すること。
)
        ...
        config: {
            ...
            responseSchema: {
                ...
                properties: {
                    ...
                    category: {
                        type: Type.STRING,
                        description: "推測される農業用勘定科目",
                        enum: ["種苗費", "肥料費", "農薬衛生費", "諸材料費", "農具費", "荷造運賃手数料", "修繕費", "動力光熱費", "接待交際費", "租税公課", "雑費", "消耗品費"]
                    },
